package com.example.admin.basic.constants;
...
//    public final static String BASE_URL = "http://img1.money.126.net/data/";
    ...
    public final static int NET_REQUEST_SUCCESS_CODE = 200;
    public final static String SIGN_MONEY = "¥";
    public final static String SIGN_PERCENT = "%";
