...
public class BtcMarketAdapter extends BaseQuickAdapter<HomeCurrencyModel, BaseViewHolder> {


    public BtcMarketAdapter(int layoutResId, @Nullable List<HomeCurrencyModel> data) {
